...
export default function Home() {
  return (
    <div>
     ...
     <section className="bg-blue-50 dark:bg-slate-800 py-30" id="contact">
    ...
    <div className="flex items-stretch justify-center">
      <div className="grid md:grid-cols-2">
        <div className="h-full pr-6">
          ...
          our eco-friendly cleaning products and state-of-the-art equipment, we prioritize sustainability without compromising on quality. We understand the importance of a clean and healthy environment, which is why we go above and beyond to exceed your expectations.
          </p>
          <ul className="mb-6 md:mb-0">
            ...
            <li className="flex">
              ...
              <div className="ml-4 mb-4">
                ...
                <p className="text-gray-600 dark:text-slate-400">Mobile: +91 6392767881</p>
                <p className="text-gray-600 dark:text-slate-400">Mail: Cleansweepvsc@gamil.com</p>
              </div>
            </li>
            <li className="flex">
              <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
